...
#		a task set with 3 periodic tasks
#		reachability test to check if the task set if schedulable
#
#		to run the test : ../../binary/xtool --reach -f 03_periodic_reach.mod

    p1, c1, d1, p2, c2, d2, p3, c3, d3: var;
    O1 = 0, T1 = 8, C1=12 , D1 = 8,  O2 = 0, T2 = 20, C2 = 5, D2 = 20,     O3 = 0, T3 = 50, C3 = 20, D3 = 50
    : parameter;

automaton act1
synclabs : r1;
loc wait_for_offset1 : while p1-O1<=0 wait 
    when p1-O1=0 sync r1 do { p1 '= p1+0} goto wait_for_period1;
