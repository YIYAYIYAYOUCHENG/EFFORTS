    ...
    T1 = 8, C1 = 2, D1 = 8,     T2 = 20, C2 = 5, D2 = 20,     T3 = 50, C3 = 20, D3 = 50: parameter; automaton sched
...
loc x3R : while c3>=0 & p3-D3<=0 wait { c1'=0, c2'=0, c3'=-1}
    ...
    when c3>0 & d3-D3=0 do {} goto error;
...
loc x2R : while c2>=0 & p2-D2<=0 wait { c1'=0, c2'=-1, c3'=0}
    ...
    when c2>0 & d2-D2=0 do {} goto error;
...
loc x1R : while c1>=0 & p1-D1<=0 wait { c1'=-1, c2'=0, c3'=0}
    ...
    when c1>0 & d1-D1=0 do {} goto error;
